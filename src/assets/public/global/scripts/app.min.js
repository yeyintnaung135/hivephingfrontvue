var App = function () {
    var t, e = !1, o = !1, a = !1, i = !1, n = [], l = "../assets/", s = "global/img/", r = "global/plugins/", c = "global/css/", d = {
        ...
        $("body").on("click", ".portlet > .portlet-title > .tools > a.remove", function (t) {
            ...
            t.preventDefault();
            var e = $(this).closest(".portlet");
            if (e.hasClass("portlet-fullscreen")) $(this).removeClass("on"), e.removeClass("portlet-fullscreen"),$(".portlet-body").removeClass("of"), $("body").removeClass("page-portlet-fullscreen"), e.children(".portlet-body").children().css({"height": "300px", "overflow": "auto"}),e.children(".portlet-body").css('height','height: 300px'); else {
                var o = 700;
                $(this).addClass("on"), e.addClass("portlet-fullscreen"),$(".portlet-body").addClass("of"), $("body").addClass("page-portlet-fullscreen"), e.children(".portlet-body").css("height", "100%"),e.children(".portlet-body").children().css({"height": "90%", "overflow": "auto"})
            }
