var Layout = function () {
    var e = "layouts/layout4/img/", a = "layouts/layout4/css/", s = App.getResponsiveBreakpoint("md"), i = [], t = [], o = function () {
        var e, a = $(".page-content"), i = $(".page-sidebar"), t = $("body");
        if (t.hasClass("page-footer-fixed") === !0 && t.hasClass("page-sidebar-fixed") === !1) {
            var o = App.getViewPort().height - $(".page-footer").outerHeight() - $(".page-header").outerHeight(), r = i.outerHeight();
            r > o && (o = r + $(".page-footer").outerHeight()), a.height() < o && a.css("min-height", o)
        } else {
            if (t.hasClass("page-sidebar-fixed")) e = l(), t.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight()); else {
                var n = $(".page-header").outerHeight(), d = $(".page-footer").outerHeight();
        ...
        var t = location.hash.toLowerCase(), o = $(".page-sidebar-menu");
        ...
        $(".page-sidebar").on("click", "li > a", function (e) {
            if (!(App.getViewPort().width >= s && 1 === $(this).parents(".page-sidebar-menu-hover-submenu").size())) {
                ...
                var a = $(this).parent().parent(), i = $(this), t = $(".page-sidebar-menu"), r = $(this).next(), n = t.data("auto-scroll"), l = parseInt(t.data("slide-speed")), d = t.data("keep-expanded");
                ...
                r.is(":visible") ? ($(".arrow", $(this)).removeClass("open"), $(this).parent().removeClass("open"), r.slideUp(l, function () {
                        n === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? t.slimScroll({scrollTo: i.position().top}) : App.scrollTo(i, p)), o()
        ...
        initHeader: function () {
            ...
            App.startPageLoading({animate: !0}), $.ajax({
                ...
                success: function (e) {
                    ...
                    a.size() > 0 && 0 === a.parents("li.open").size() && $(".page-sidebar-menu > li.open > a").click(), s.html(e), Layout.fixContentHeight(), App.initAjax()
                },
