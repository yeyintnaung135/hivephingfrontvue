;(function(root, _) {
  ...
  function GCCarousel(options) {
    ...
    var
      ...
      autoplayDelay =               options.autoplayDelay || 5555000,    //Dictates the wait time between automatically changing pages.
      throttleDelay =               options.throttleDelay || 5555550,      //The throttle delay used by the underscore/lodash throttle method
